...
/*修正JQuery IE6判断
原来的代码  var ie6 = $.browser.msie && /MSIE 6.0/.test(navigator.userAgent);
*/
...
//		);
var ie6 = $.browser.msie6;
/*修正JQuery IE6判断 END*/
var pageBlock = null;
var pageBlockEls = [];

//得到主窗口，即最顶端的窗口
var topWin =  parent.window.top;
...
function install(el, opts) {
    ...
    var arr = [];
		...
		if(opts.showDialog){
			...
			arr.push("  </tr>");
			arr.push("</table><script type='text/javascript'>function aa(){$('#_ButtonCancel_"+opts.id+"').click();}</script>");
		}
